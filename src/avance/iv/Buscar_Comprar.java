...
public class Buscar_Comprar extends listaJuegos
{
    ...
    public void buscar()
    {
        ...
        switch (ID)
        {
            ...
            break;
            case 2:
            JOptionPane.showMessageDialog(null,"FIFA22] *ID 2*, Unidades Disp: [15], Precio Unidad: [23000], Plataformas: [PS4,PS5,PC,XBOX]");
            compra();
